...
?>
        <tbody class="mb-4">
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center justify-content-center h-100 "> $<?php echo number_format($price * $quantity); ?>
                    </div>
                </td>
                <td>
                    <div class="d-flex align-items-center justify-content-center h-100 "> $<?php echo number_format($price * $quantity); ?>
        ...
        <div class="d-flex align-items-center h-100 purchase">
            ...
            <div>
                <div class="d-flex align-items-baseline">
                    <h5><?php echo esc_attr($title); ?></h5>
                    <div class="x">x<?php echo esc_html($quantity); ?></div>
                </div>
                <div class="d-flex align-items-center price">
                    <p>$<?php echo number_format($price); ?></p>
                    <span>$<?php echo number_format($regular_price); ?></span>
                </div>
            </div>
        </div>
<?php
