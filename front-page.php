...
// Clave única para el caché de la página de inicio
$cache_key = 'front_page_cache';
$cache_expiration = HOUR_IN_SECONDS; // Tiempo de expiración del caché (1 hora)

// Intentar obtener el contenido del caché
$cached_content = get_transient($cache_key);

if ($cached_content === false) {
  // Si no hay contenido en caché, generar el contenido
  ob_start();

  // Aquí comienza el contenido de la página de inicio
...
?>
  ...
  <!-- Aquí puedes incluir el resto del contenido de la página -->
<?php
  // Fin del contenido de la página de inicio

  // Guardar el contenido generado en el caché
  $cached_content = ob_get_clean();
  set_transient($cache_key, $cached_content, $cache_expiration);
}

// Imprimir el contenido (desde el caché o recién generado)
echo $cached_content;
