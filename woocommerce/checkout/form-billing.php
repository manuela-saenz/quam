									...
									<form onSubmit="return false">
											...
											<div class="form-group row">
												<div class="col-lg-8 col-md-12">
													...
													<div class="d-lg-flex d-none flex-column">
														<label
															class="custom-checkbox d-flex align-items-baseline mb-4"><input
																class="politicy check me-3" type="checkbox" id="cboxtwo"
														...
														<label class="quam-btn blue next"
															onclick="stepper1.next()">Diligenciar información</label>
													</div>
													...
													<div class="code">
														<form method="post" class="position-relative">
															<div class="position-relative">
																<input type="text" id="codigo_descuento"
																	name="codigo_descuento"
																	placeholder="Código de descuento" required>
																<input type="submit" class="quam-btn blue codigo"
																	value="Aplicar">
															</div>
															<div class="mt-4">
														...
														<div class="d-lg-none d-flex flex-column check">
															<label
																class="custom-checkbox d-flex align-items-baseline mb-4 "><input
																	class="politicy check me-3" type="checkbox"
																	id="cboxtwo" value="first_checkbox">
															...
															<div class="btn-next center-all w-100">
																<label class="quam-btn blue w-100 next"
																	onclick="stepper1.next()">Diligenciar
																	información</label>
															</div>
										...
										<div id="test-l-2" role="tabpanel" class="bs-stepper-pane"
												...
												<div class="col-lg-8">
													...
													<div class="position-relative">
														<form action="" class="form_contact">
															<div class="row">
																<div class="col-md-6 fw-bold input-form-name">
																	<?php woocommerce_form_field(1, $fields['billing_first_name'], $checkout->get_value(1)); ?>
																</div>
																<div class="col-md-6 fw-bold">
																	<?php woocommerce_form_field(2, $fields['billing_last_name'], $checkout->get_value(2)); ?>
																</div>
																<div class="col-md-6 fw-bold">
																	<?php woocommerce_form_field(3, $fields['billing_id'], $checkout->get_value(3)); ?>
																</div>
																<div class="col-md-6 fw-bold">
																	<?php woocommerce_form_field(12, $fields['billing_email'], $checkout->get_value(12)); ?>
																</div>
																<div class="col-md-6 fw-bold">
																	<?php woocommerce_form_field(11, $fields['billing_phone'], $checkout->get_value(11)); ?>
																</div>
															</div>
														...
														<div class="btn-step-next">
															<label class="quam-btn blue next"
																onclick="stepper1.next()">Diligenciar ubicación</label>
														</div>
														...
														<form method="post" class="position-relative form_compra">
															...
															<div class="position-relative mt-5">
																<input type="text" id="codigo_descuento"
																	name="codigo_descuento"
																	placeholder="Código de descuento" required>
																<input type="submit" class="quam-btn blue"
																	value="Aplicar">
															</div>
											...
											<div class="d-flex justify-content-end mt-5">
												<label class="quam-btn blue me-4 previous"
													onclick="stepper1.previous()"><i class="icon-arrow-left me-2"></i>
													Volver a la bolsa de la compra</label>
										...
										<div id="test-l-3" role="tabpanel" class="bs-stepper-pane"
												...
												<div class="col-lg-8 ">
													...
													<div class="position-relative">
														<form action="" class="form_contact">
															<div class="row">
																<div class="col-md-6">
																	<?php woocommerce_form_field(4, $fields['billing_company'], $checkout->get_value(4)); ?>
																</div>
																<div class="col-md-6">
																	<?php woocommerce_form_field(5, $fields['billing_country'], $checkout->get_value(5)); ?>
																</div>
																<div class="col-md-6">
																	<?php woocommerce_form_field(6, $fields['billing_address_1'], $checkout->get_value(6)); ?>
																</div>
																<div class="col-md-6">
																	<?php woocommerce_form_field(8, $fields['billing_city'], $checkout->get_value(8)); ?>
																</div>
																<div class="col-md-6">
																	<?php woocommerce_form_field(9, $fields['billing_state'], $checkout->get_value(9)); ?>
																</div class="col-md-6">
																<div class="col-md-6">
																<?php woocommerce_form_field(10, $fields['billing_postcode'],$checkout->get_value(10)); ?>
																</div>
															</div>
															<div class="alert alert-danger" role="alert"
																id="error_alert"
																style="display:none; color: #721c24; background-color: #f8d7daa1; border: 2px solid #f5c6cb; padding: 13px; margin-bottom: 10px;">
															</div>
															<div class="alert alert-success" role="alert"
																id="success_alert"
																style="display:none; color: #155724; background-color: #d4eddaa1; border:1px solid #c3e6cb; #f5c6cb; padding: 13px; margin-bottom: 10px;">
															</div>
														</form>
														...
														<div class="btn-step-next">
															...
															<label class="quam-btn blue next"
																onclick="stepper1.next()">Generar pedido</label>
														</div>
											...
											<div class="d-flex justify-content-end mt-5">
												<button class="quam-btn blue me-4 previous"
													onclick="stepper1.previous()"><i class="icon-arrow-left me-2"></i>
											...
											<div class="form-group row">
												<div class="col-lg-8 position-relative">
													...
													<div class="tab-content" id="pills-tabContent">
														...
														<div class="tab-pane fade position-relative" id="pills-contact"
															...
															<div class="btn-step-next">
																<button class="quam-btn blue next"
																	onclick="redirectToPaymentGateway()">Comprar
																	ahora</button>
															</div>
														</div>
													</div>
										...
										<div id="test-l-5" role="tabpanel" class="bs-stepper-pane"
											...
											<div class="form-group row center-all">
												<div
													class="col-md-6 position-relative center-all text-center flex-column">
													<div class="circle">
											...
											<div class="d-flex justify-content-end mt-5">
												<button class="quam-btn blue me-4 previous"
													onclick="stepper1.previous()"><i
														class="icon-arrow-left me-2"></i>Volver al pago</button>
