											...
											<div class="col-md-12">
												...
												<div class="d-lg-flex d-none flex-column">
													...
													<button type="button" class="quam-btn blue next"
														onclick="stepper1.next()">Diligenciar información</button>
												</div>
											</div>
											<?php
											...
											<div class="col-lg-12">
												...
												<div class="position-relative">
													...
													<div class="btn-step-next">
														<button id="boton-id" type="button"
															class="quam-btn blue next mt-2"
															onclick="stepper1.next()">Diligenciar ubicación</button>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-12">
												...
												<div class="position-relative">
													...
													<div class="btn-step-next">
														...
														<button id="boton-lo" type="button"
															class="quam-btn blue next mt-2"
															onclick="stepper1.next()">Generar pedido</button>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-12 position-relative">
												...
												<div class="tab-content" id="pills-tabContent">
													...
													<div class="tab-pane fade position-relative" id="pills-contact"
														...
														<div class="btn-step-next">
															<button type="submit" class="quam-btn blue next"
								...
								<div class="code">
									...
									<div class="d-lg-none d-flex flex-column check">
										...
										<div class="btn-next center-all w-100">
											<button type="button" class="quam-btn blue w-100 next"
