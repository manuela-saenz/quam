											...
											<div class="col-lg-12">
												...
												<div class="position-relative">
													...
													<div class="btn-step-next">
														<button type="button" class="quam-btn blue next" onclick="stepper1.next()">Diligenciar ubicación</button>
													</div>
												...
												<div class="position-relative">
													<div class="form_contact">
														<div class="row">
															...
															<div class="col-md-6">
																<?php woocommerce_form_field(7, $fields['billing_addres_2'], $checkout->get_value(7)); ?>
															</div>
															<div class="col-md-6">
													...
													<div class="btn-step-next">
														...
														<button type="button" class="quam-btn blue next" onclick="stepper1.next()">Generar pedido</button>
													</div>
											...
											<div class="col-lg-12 position-relative">
												...
												<div class="tab-content" id="pills-tabContent">
													...
													<div class="tab-pane fade position-relative" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
														...
														<div class="btn-step-next">
															<button type="button" class="quam-btn blue next" onclick="redirectToPaymentGateway()">Comprar
																ahora</button>
														</div>
													</div>
												</div>
